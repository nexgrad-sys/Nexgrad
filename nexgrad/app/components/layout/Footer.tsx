      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-4 gap-12">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xl font-semibold text-white">NexGrad</span>
          </div>

          <p className="text-gray-400 text-sm leading-relaxed">
            Empowering professionals worldwide with transformative higher
            education programs from prestigious partner universities.
          </p>
