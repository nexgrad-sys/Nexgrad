      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            NexGrad is a leading global higher education platform connecting
            ambitious professionals with world-class MBA and DBA programs from
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="group bg-white p-10 rounded-2xl shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-gray-100">
            ...
            <p className="text-gray-600 leading-relaxed text-[16px]">
              To become the most trusted platform for executive education
              globally, bridging the gap between ambition and achievement.
            </p>
          </div>
        </div>
