      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gradient-to-br from-red-600 to-red-700 text-white rounded-2xl p-8 col-span-2 relative overflow-hidden">
            ...
            <h3 className="text-3xl font-semibold mb-3">Enrollments Open</h3>

            <p className="text-white/80 max-w-md mb-6">
              Secure your spot in our upcoming intake. Limited seats available
...
"
          >
            ...
            <h4 className="font-semibold text-lg mb-2">World-Class Faculty</h4>

            <p className="text-gray-500 text-sm mb-4">
              Learn from 200+ renowned professors and industry experts from top
              global institutions.
            </p>
...
duration-300"
          >
            ...
            <p className="text-sm text-gray-500">Average salary increase</p>
          </div>

          {/* STATS CARD */}
          <div
            className="bg-white rounded-2xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.06)] 
hover:shadow-[0_12px_40px_rgba(0,0,0,0.12)] 
